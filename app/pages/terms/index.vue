      ...
      <div class="space-y-8">
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            not use our services. We reserve the right to update these Terms at
            any time, and your continued use constitutes acceptance of any
            changes.
          </p>
        </section>
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            Unless otherwise stated, we and our licensors own all intellectual
            property rights for material on the website. You are granted a
            limited license to access and use our services for personal,
            non-commercial purposes.
          </p>
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            <strong>Your Content:</strong> You retain ownership of content you
            submit. By uploading content, you grant us a worldwide,
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            violates these Terms or is otherwise objectionable. We may suspend
            or terminate accounts that repeatedly violate our policies.
          </p>
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
            However, we are not obligated to monitor all content and cannot
            guarantee the accuracy, quality, or legality of user-submitted
            content.
          </p>
        </section>
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            part of our services at any time without notice. We are not liable
            for any service interruptions, modifications, or terminations.
          </p>
        </section>
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            practices of any third-party sites. Your use of third-party sites is
            at your own risk.
          </p>
        </section>
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            or error-free, or that any defects will be corrected. The materials
            on our website may contain technical, typographical, or photographic
            errors.
          </p>
        </section>
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
            You agree to indemnify, defend, and hold harmless GIC Student
            Portal, its affiliates, officers, directors, employees, and agents
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            page and updating the "Last updated" date. Your continued use after
