    ...
    <UContainer class="max-w-4xl">
      ...
      <div class="space-y-8">
        ...
        <section
          ...
          <ul class="space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              ...
              service providers who assist us in operating our platform, subject
              to confidentiality agreements
            </li>
            <li>
              • <strong>Educational Institutions:</strong> With your school or
              educational institution as part of the GIC program
            </li>
            <li>
              • <strong>Public Display:</strong> Project information you choose
              to make public will be visible to other users
            </li>
            <li>
        ...
        <section
          ...
          <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
            Our service is intended for students participating in the GIC
            program. If you are under 18, please ensure you have parental or
            guardian consent before using our services. We do not knowingly
            collect personal information from children under 13 without parental
            consent. If we become aware that we have collected such information,
