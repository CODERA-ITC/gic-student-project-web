<template>
  <div class="min-h-screen bg-gray-50 dark:bg-slate-900">
    ...
    <UContainer class="py-12">
      ...
      <!-- Empty State -->
      <div v-if="filteredFavorites.length === 0" class="flex flex-col items-center justify-center py-20">
        ...
        <ButtonsPresetButton preset="exploreProjects" @click="$router.push('/projects')" />
      </div>

      <!-- Projects Grid -->
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
        <ProjectCard v-for="project in filteredFavorites" :key="project.id" :project="project"
...
useHead({
  title: "Favorite Projects - GIC Showcase",
  meta: [
    {
      name: "description",
