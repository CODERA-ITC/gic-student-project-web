<template>
  <div class="min-h-screen bg-gray-50 dark:bg-slate-900">
    ...
    <div v-else>
      <!-- Header Section -->
      <div class="py-16 bg-white dark:bg-slate-800 border-b border-blue-700/30 dark:border-slate-700">
        <UContainer>
          <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
            <div class="space-y-2">
              <h1 class="text-3xl sm:text-4xl lg:text-5xl font-black text-black dark:text-white">
                Welcome back,
            ...
            <ButtonsPresetButton preset="createProject" to="/projects/create" size="md" class="w-full sm:w-auto" />
          </div>
        </UContainer>
      </div>
      ...
      <UContainer class="py-12 mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
          <div v-for="stat in stats" :key="stat.label"
            ...
            <div class="flex items-center gap-3 mb-4">
              <UIcon :name="stat.icon" class="w-6 h-6 text-gray-600 dark:text-slate-400" />
        ...
        <!-- My Projects -->
        <div class="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6 mb-8">
          <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-bold text-black dark:text-white">
              Recent Projects
            </h2>
            <NuxtLink to="my-projects" class="text-blue-400 hover:text-blue-300 text-sm font-semibold">
              View All →
            </NuxtLink>
          </div>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div v-for="project in recentProjects" :key="project.id"
              ...
              <div class="flex items-start justify-between mb-3">
                ...
                <span :class="project.statusColor" class="text-xs font-semibold px-2 py-1 rounded">
                  {{ project.status }}
                </span>
              </div>
              <div class="space-y-2">
                ...
                <div class="w-full bg-gray-300 dark:bg-slate-600 rounded-full h-1.5">
        ...
        <div
          ...
          <div class="space-y-3">
            <div v-for="update in updates" :key="update.id" :class="update.bgColor"
              class="p-4 rounded-lg hover:scale-[1.01] transition-all duration-200 cursor-pointer group">
              <div class="flex items-start gap-4">
                <div :class="update.iconBgColor" class="p-2.5 rounded-lg flex-shrink-0">
