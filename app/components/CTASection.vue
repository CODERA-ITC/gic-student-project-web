<template>
  <section class="py-20 bg-white dark:bg-slate-900">
    <div
      class="w-full rounded-t-4xl overflow-hidden border border-blue-200/30 dark:border-blue-700/50 bg-gradient-to-br from-blue-800 via-blue-900 to-indigo-900 dark:from-blue-900 dark:via-blue-950 dark:to-indigo-950 shadow-2xl"
    >
      <div class="text-center space-y-8 max-w-2xl mx-auto py-12 sm:py-14 px-4 sm:px-6 lg:px-8">
