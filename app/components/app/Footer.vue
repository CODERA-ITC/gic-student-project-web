<template>
  <footer class="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    <UContainer>
      <div class="py-16">
        <div class="grid md:grid-cols-4 gap-8">
          ...
          <!-- Programs -->
          <div>
            <h3 class="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Programs</h3>
            <ul class="space-y-3">
              <li>
                <NuxtLink to="/students?program=Computer%20Science"
                  class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Computer Science
                </NuxtLink>
              </li>
              ...
              <li>
                <NuxtLink to="/students?program=Information%20Systems"
                  class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Information Technology
                </NuxtLink>
              </li>
              <li>
                <NuxtLink to="/students?program=Data%20Science"
                  class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Data Science
                </NuxtLink>
              </li>
              <li>
                <NuxtLink to="/students?program=Software%20Engineering"
                  class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
