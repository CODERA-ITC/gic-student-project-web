<template>
  <div class="grid lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-8">
      ...
      <section ref="sectionRef" class="opacity-0">
        <div
          class="bg-white/50 dark:bg-slate-800/50 backdrop-blur border border-gray-200 dark:border-slate-700 rounded-xl p-6 space-y-4"
        >
          <div class="flex items-start gap-4">
            <UIcon
              ref="iconRef"
              name="i-heroicons-clock"
              class="w-6 h-6 text-purple-500 dark:text-purple-400 mt-1 flex-shrink-0"
            />
            <div class="flex-1">
              <h3
                ref="titleRef"
              ...
              <div class="w-full relative space-y-8 p-6">
                <!-- Vertical line -->
                <div
                  class="absolute left-6 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-green-500 via-blue-500 to-gray-300 dark:to-gray-600 transform md:-translate-x-1/2"
                />
      ...
      <div class="sticky top-28 space-y-6">
        ...
        <div class="space-y-3">
          ...
          >
            ...
            {{
              project.visibility === "private" ? "Show Project" : "Hide Project"
            }}
          </UButton>
...
onMounted(() => {
  ...
  // 1. Animate section fade in
  masterTl.to(sectionRef.value, {
    opacity: 1,
    duration: 0.5,
    ease: "power2.out",
  });

  // 2. Icon dramatic entrance with rotation
  masterTl.fromTo(
    iconRef.value?.$el,
    {
      scale: 0,
  ...
  // 3. Add continuous pulse to icon
