<template>
  <div class="group relative h-full w-full max-w-md mx-auto flex flex-col overflow-hidden rounded-3xl
    ...
    <div
      ...
      <img v-if="headerImage" :src="headerImage" alt="Profile header"
    ...
    <div class="relative px-2 sm:px-3 pt-4 pb-2 flex-1 flex flex-col justify-between gap-4">
      <div class="flex-1">
        ...
        <div class="flex justify-left -translate-y-16">
          <div class="relative h-32 w-32 overflow-hidden rounded-full border-4 border-white dark:border-gray-800 bg-white dark:bg-gray-800 shadow-2xl
        ...
        <div class="text-left -mt-6">
          ...
          <p class="mt-1 text-xs font-semibold text-blue-900/70 dark:text-blue-200 uppercase tracking-[0.2em]">
            {{ mainSkill }}
          </p>
        </div>
        ...
        <div class="mt-4 h-20 overflow-hidden">
          <div class="flex flex-wrap justify-start gap-2">
            <UBadge v-for="(tech, index) in displayedTech" :key="`tech-${index}`" color="neutral" variant="soft"
              size="sm"
            ...
            <UBadge v-if="remainingTechCount > 0" color="neutral" variant="outline" size="sm" class="text-xs bg-slate-50/80 dark:bg-slate-800/70 text-slate-700 dark:text-blue-200 px-3 py-1 rounded-xl border border-slate-300 dark:border-slate-600 font-semibold
      ...
      <div class="flex-shrink-0">
        ...
        <div class="mt-4 flex justify-center w-full">
          <ButtonsPresetButton @click="handleViewProfile" preset="viewProfileStudent"
