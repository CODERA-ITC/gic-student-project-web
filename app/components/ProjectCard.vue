  ...
  <div class="block group cursor-pointer">
    <div :class="[
      ...
      <div
        ...
        <!-- Images Carousel -->
        <div v-if="hasValidImages" class="relative w-full h-full rounded-2xl overflow-hidden hover:shadow-xl p-1">
          <!-- Views -->

          <img :src="currentImageUrl" :alt="project.name || 'Project image'"
          ...
          <div v-if="showEditButton && isProjectAuthor"
            ...
            <!-- Delete Icon -->
            <button @click.prevent.stop="$emit('delete', project.id)"
          ...
          <div v-if="project.images.length > 1"
            ...
            <button v-for="(_, idx) in project.images" :key="idx" @click.stop.prevent="handleDotClick(idx)" :class="[
      ...
      <div class="p-5 space-y-4 flex flex-col gap-2">
        ...
        <div class="flex flex-col">
          <div class="flex items-center justify-between mb-1">
            <h3 class="text-lg font-semibold text-slate-900 dark:text-white transition-colors line-clamp-2 mb-1">
              {{ project.name }}
            </h3>
            ...
            <div class="flex flex-col gap-3 items-end">
              <button v-if="showLikeButton" @click.prevent.stop="toggleLikeHandler" :class="[
          ...
          <div class="flex flex-wrap items-center gap-2 text-xs">
            <span
              ...
              <UIcon name="i-heroicons-swatch" class="w-3.5 h-3.5 text-blue-600 dark:text-blue-300" />
            ...
            <span
              ...
              <UIcon name="i-heroicons-eye" class="w-3.5 h-3.5 text-blue-700 dark:text-blue-300" />
            ...
            <span
              ...
              <UIcon name="i-heroicons-heart-solid" class="w-3.5 h-3.5 text-rose-600 dark:text-rose-300" />
        ...
        <!-- Description -->
        <p class="text-blue-900/70 dark:text-gray-300/70 text-sm leading-relaxed line-clamp-2">
          {{ project.description }}
        </p>
        ...
        <div class="flex content-center items-center justify-between">
          <div v-if="project.members && project.members.length > 0">
            <div class="flex items-center gap-1">
              <div v-for="(member, idx) in project.members.slice(0, 3)" :key="idx"
                ...
                <img v-if="member.image" :src="member.image" alt="Member photo" class="w-full h-full object-cover" />
              ...
              <!-- +X more -->
              <span v-if="project.members.length > 3" class="text-xs text-blue-900/60 dark:text-blue-400/60 ml-1">
          ...
          <div class="flex gap-2">
            ...
            <!-- View button -->
            <ButtonsPresetButton preset="viewDetails" size="sm" :to="`${baseRoute}/${project.id}`"
...
const toggleLikeHandler = () => {
  ...
  console.log(
    `Toggled like for project ID: ${props.project.id}, new like status: ${isLiked.value ? "liked" : "unliked"
    }`,
  );
};
